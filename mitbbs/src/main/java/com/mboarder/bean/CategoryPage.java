...
public class CategoryPage {
	...
	private static  String[] categoryName = { "General Military Discussion",
			"Ground Forces", "Naval Forces",
			"Air Forces", "Strategic Forces and Space",
			"Sports", "Politics & Media",
			"Economics & Business", "Science & Technology",
			"Culture & Society", "Everything Else",
			"Before 1911", "After 1911" };
	...
	public void init(){
		...
		this.add("General Military Discussion", "General",
				"http://www.china-defense.com/smf/index.php?board=12.0");
		this.add("General Military Discussion", "Current Wars",
				"http://www.china-defense.com/smf/index.php?board=20.0");
		this.add("General Military Discussion", "People's Armed Police & Militia",
				"http://www.china-defense.com/smf/index.php?board=20.0");
